...
{
    /// <summary>非致命な失敗を通知する。category は "sweep-temp"/"sweep-old-sessions" (BK-M-2)/
    /// "load-all"/"restore-item"/"restore-item-later"/"backup-load-failed" (BK-L-6)/
    /// "backup-content-skipped" (BK-M-3) のいずれか。</summary>
