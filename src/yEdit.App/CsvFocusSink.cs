...
/// （P6=2026-07-06 時点の状態: EditorControl 単一経路への移行により、下記のネイティブ Scintilla 統合を
/// 前提とした説明は歴史的コンテキスト。CsvFocusSink 機能自体の撤去は P7 の実機総合検証合格後に判断する
/// 申し送りとなっており、class 本体・振る舞い・AccessibleName/Role は現時点で無変更のまま存置。）
